...
const TABLA_INTERIORES := [
	...
	{ "id": "interior_herreria_pb", "nombre": "Herrería Calavera y Ancla",
	  ...
	  "asset_muro_esquina": "interior.herreria_v1.muro_esquina",
	  "asset_borde_pilar": "interior.herreria_v1.muro_borde_pilar",
	  "entrada": Vector2i(4, 6),
	  "muebles": [
		  ...
		  { "tipo": "panoplia", "casilla": Vector2i(0, 3), "solido": false,
			"capa_visual": "pared", "asset": "mueble.herreria.panoplia_armas" },

		  { "tipo": "fragua", "casilla": Vector2i(2, 1), "solido": true,
			...
			"horario_id": "herrero" },
		  # Yunque, horno y mesa de trabajo comparten temporalmente el mismo
		  # station_id "herreria" que fragua y banco: hoy TABLA_RECETAS no
		  # distingue por objeto físico, solo por edificio. Los cinco abren
		  # el mismo panel con las mismas 4 recetas hasta que existan
		  # recetas especializadas por estación.
		  { "tipo": "horno", "casilla": Vector2i(4, 1), "solido": true,
			"capa_visual": "mundo", "asset": "mueble.herreria.horno",
			"interactuable": "crafteo", "estacion_id": "herreria", "accion": "Usar horno",
			"horario_id": "herrero" },
		  { "tipo": "estanteria", "casilla": Vector2i(6, 1), "solido": true,
			"capa_visual": "mundo", "asset": "mueble.herreria.estanteria_herramientas" },
		  { "tipo": "carbon", "casilla": Vector2i(7, 1), "solido": true,
			"capa_visual": "mundo", "asset": "mueble.herreria.deposito_carbon" },
		  { "tipo": "escalera", "casilla": Vector2i(8, 1), "solido": true,
			"capa_visual": "mundo", "asset": "mueble.comun.escalera_madera",
			"huella": Vector2i(1, 2) },
		  { "tipo": "yunque", "casilla": Vector2i(4, 3), "solido": true,
			"capa_visual": "mundo", "asset": "mueble.herreria.yunque",
			"interactuable": "crafteo", "estacion_id": "herreria", "accion": "Usar yunque",
			"horario_id": "herrero" },
		  { "tipo": "cofre", "casilla": Vector2i(1, 3), "solido": true,
		  ...
		  # Decoración de la Fase 6.1. No sólidas a propósito: no deben poder
		  # bloquear ninguna ruta, sea cual sea su posición.
		  { "tipo": "cartel", "casilla": Vector2i(0, 5), "solido": false,
			"capa_visual": "pared", "asset": "mueble.herreria.cartel_yunque" },
		  { "tipo": "farol", "casilla": Vector2i(2, 0), "solido": false,
			"capa_visual": "pared", "asset": "mueble.herreria.farol" },
		  { "tipo": "saco", "casilla": Vector2i(7, 2), "solido": false,
			"capa_visual": "mundo", "asset": "mueble.herreria.saco_carbon" },
	  ] },
...
const TABLA_ANIMALES := [
	{ "id": "cerdo_salvaje", "nombre": "Cerdos Salvajes de la Isla", "tipo": "ganado",
	  ...
	  "generar_en_mundo": true, "orden_mundo": 1,
	...
	{ "id": "cabra_montana", "nombre": "Cabras de Montaña", "tipo": "ganado",
	  ...
	  "generar_en_mundo": true, "orden_mundo": 2,
	...
	{ "id": "loro_vigia", "nombre": "Loros Vigías", "tipo": "utilidad",
	  ...
	  "generar_en_mundo": true, "orden_mundo": 3,
...
const TABLA_CULTIVOS := [
	{ "id": "citricos", "nombre": "Cítricos", "semilla": "semilla_citrico",
	  ...
	  "fertilizante": "fertilizante", "multiplicador_fertilizante": 0.75 },
	{ "id": "cana_azucar", "nombre": "Caña de Azúcar", "semilla": "semilla_cana",
	  "cosecha": { "cana_azucar": 4 }, "horas_crecimiento": 20.0,
	  "fertilizante": "fertilizante", "multiplicador_fertilizante": 0.70,
	...
	{ "id": "tabaco", "nombre": "Tabaco", "semilla": "semilla_tabaco",
	  ...
	  "fertilizante": "fertilizante", "multiplicador_fertilizante": 0.80 },
]
